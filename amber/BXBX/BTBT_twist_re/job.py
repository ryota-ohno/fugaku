...
def init_process(args):
    ...
    for theta in theta_list:
        ...
        '\n',
        f'python /vol0303/data/hp260444/Working/fugaku/amber/BXBX/src/step1_8_xyz_new_0.py --auto-dir {args.auto_dir}/{dir_name} --monomer-name {monomer_name} --num-nodes 10\n',
        '\n',
        '#sleep 12 \n'
            ]
