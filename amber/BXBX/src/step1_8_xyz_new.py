...
def main_process(args):
    auto_dir = f'/vol0303/data/hp260444/Working/fugaku/amber/BXBX/{args.auto_dir}'
    os.makedirs(auto_dir, exist_ok=True)
    os.makedirs(os.path.join(auto_dir,'amber'), exist_ok=True)
    os.makedirs(os.path.join(auto_dir,'gaussview'), exist_ok=True)
    amber_path=os.path.join(auto_dir,'amber')
    shutil.copy(f'/vol0303/data/hp260444/Working/fugaku/amber/BXBX/src/FF_calc.in',amber_path)
    shutil.copy(f'/vol0303/data/hp260444/Working/fugaku/amber/BXBX/monomer/{args.monomer_name}.frcmod',amber_path)
