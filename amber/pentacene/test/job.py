...
def init_process(args):
    ...
    theta_list=[5.0,10.0,15.0, 20.0, 25.0, 30.0, 35.0, 40.0, 45.0]
    for theta in theta_list:
        ...
        '\n',
        f'python /vol0303/data/hp260444/Working/fugaku/amber/pentacene/src/step1_8_xyz_new.py --auto-dir {args.auto_dir}/{dir_name} --monomer-name {monomer_name} --num-nodes 3\n',
        '\n',
        '#sleep 12 \n'
            ]
