...
def init_process(args):
    ...
    for z in z_list:
        ...
        '\n',
        f'python /vol0303/data/hp260444/Working/fugaku/amber/BTBTB/src/step1_8_xyz_new_0_.py --auto-dir {args.auto_dir}/{dir_name} --monomer-name {monomer_name} --num-nodes 16\n',
        '\n',
        '#sleep 12 \n'
            ]
