...
def main_process(args):
    auto_dir = f'/home/u15256/Working/fugaku/amber/BTBTB/{args.auto_dir}'
    os.makedirs(auto_dir, exist_ok=True)
    os.makedirs(os.path.join(auto_dir,'amber'), exist_ok=True)
    os.makedirs(os.path.join(auto_dir,'gaussview'), exist_ok=True)
    amber_path=os.path.join(auto_dir,'amber')
    shutil.copy(f'/home/u15256/Working/fugaku/amber/BTBTB/src/FF_calc.in',amber_path)
    shutil.copy(f'/home/u15256/Working/fugaku/amber/BTBTB/monomer/{args.monomer_name}.frcmod',amber_path)
    ...
    mono_file=f'/home/u15256/Working/fugaku/amber/BTBTB/monomer/{args.monomer_name}_mono.out'
