...
def get_monomer_xyzR(monomer_name,Ta,Tb,Tc,A2,A3):
    ...
    df_mono=pd.read_csv('/vol0303/data/hp260444/Working/fugaku/gaussian/BXBX/monomer/{}.csv'.format(monomer_name))
...
def get_xyzR_lines(xyzR_array,file_description):
    lines = [     
        '%mem=20GB\n',
        '%nproc=48\n',
        '#P TEST PBEPBE/Def2TZVP EmpiricalDispersion=GD3BJ counterpoise=2\n',###汎関数や基底関数系は適宜変更する
        '\n',
        file_description+'\n',
        '\n',
        '0 1 0 1 0 1\n'
